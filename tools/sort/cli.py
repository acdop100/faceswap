...
from lib.cli.actions import SaveFileFullPaths
from lib.cli.actions import Slider
...
_METHOD_TEXT = {
    ...
    "distance": _(
        "faces by the estimated distance of the alignments from an 'average' face. This "
    ...
    "size": _(
        "images by their size in the original frame. Faces further from the camera and from "
...
_BIN_TYPES = [
    ...
    (
        ("color-black", "color-gray", "color-luma", "color-green", "color-orange"),
        _GPCOLOR,
    ),
