...
from .sort_methods import SortColor
from .sort_methods import SortFace
from .sort_methods import SortHistogram
from .sort_methods import SortMultiMethod
from .sort_methods_aligned import SortDistance
from .sort_methods_aligned import SortFaceCNN
from .sort_methods_aligned import SortPitch
from .sort_methods_aligned import SortRoll
from .sort_methods_aligned import SortSize
from .sort_methods_aligned import SortYaw
...
class Sort:  # pylint:disable=too-few-public-methods
    ...
    def _handle_deprecations(self):
        ...
        if self._args.final_process:
            deprecation_warning(
                "`-fp`, `--final-process`", "This option will be ignored"
            )
            logger.warning(
                "Final processing is dictated by your choice of 'sort-by' and "
        ...
        if "face-yaw" in (self._args.sort_method, self._args.group_method):
            deprecation_warning(
                "`face-yaw` sort option", "Please use option 'yaw' going forward."
            )
