...
class Writer(Output):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self._output_dimensions: None | (
            tuple[int, int]
        ) = None  # Fix dims on 1st received frame
    ...
    def _set_frame_order(
        total_count: int, frame_ranges: list[tuple[int, int]] | None
    ) -> list[int]:
    ...
    def _get_writer(self) -> GIFFormat.Writer:
        ...
        return imageio.get_writer(self._gif_file, mode="i", **self._gif_params)
