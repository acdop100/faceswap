...
from .actions import DirFullPaths
from .actions import DirOrFileFullPaths
from .actions import DirOrFilesFullPaths
from .actions import FileFullPaths
from .actions import FilesFullPaths
from .actions import MultiOption
from .actions import Radio
from .actions import SaveFileFullPaths
from .actions import Slider
...
class SmartFormatter(argparse.HelpFormatter):
    ...
    def _split_lines(self, text: str, width: int) -> list[str]:
        ...
        return argparse.HelpFormatter._split_lines(
            self, text, width  # pylint: disable=protected-access
        )
    ...
    def get_optional_arguments() -> list[dict[str, Any]]:
        ...
        argument_list.append(
            dict(
                ...
                choices=[
                    mask
                    for mask in PluginLoader.get_available_extractors("mask")
    ...
    def get_argument_list() -> list[dict[str, Any]]:
        ...
        argument_list.append(
            dict(
                ...
                group=_("model"),
                help=_(
                    "R|Load the weights from a pre-existing model into a newly created model. "
